/**
* Não compartilha death cabeçuda 😮‍💨
 */
...
const { generateWAMessageFromContent, prepareWAMessageMedia, generateMessageIDV2 } = require('@whiskeysockets/baileys');
