...
const mensagens = [
"Aguarde... enviando sua solicitação, não precisa pressionar o botão... ops, não tem botão.",
"Processando... se demorar, culpe sua internet, não eu.",
"Carregando... quase pronto, não suma agora que já esperei você.",
"Aguarde... preparando seu pedido com carinho... ou pelo menos tentando.",
"Enviando... não feche o chat, isso me deixa emocionalmente instável.",
"Processando... a Shizuku está trabalhando, diferente de você.",
"Aguarde... organizando tudo, porque bagunça já basta sua solicitação.",
"Carregando... se demorar, finja que é suspense.",
"Enviando... quase lá, não precisa atualizar 10 vezes.",
"Aguarde... Shizuku está pensando... isso pode levar alguns segundos.",
"Processando... não precisa ficar nervoso, eu sei que você é ansioso.",
"Carregando... quase pronto, segura a emoção.",
"Enviando... aguarde, não fui programada pra milagre.",
"Processando... calma, não vou fugir com seu pedido.",
"Aguarde... enfiando... ops, enviando sua solicitação."
];


const enviar = {
  espere: () => random(mensagens),
  aguarde: "Aguarde... a Shizuku está trabalhando, algo raro hoje em dia.",
  sucesso: "Sucesso... pronto, entregue. Não diga que nunca fiz nada por você.",
  levelon: "Level ativado... vamos ver se agora você evolui ou continua no nível iniciante.",
  leveloff: "Level desativado... desistir também é uma escolha, né?",
  levelnoton: "Leveling inativo... você esqueceu de ativar ou só desistiu mesmo?",
  levelErr: "Erro no sistema... calma, estou resolvendo antes que você culpe o bot.",

  error: {
    sticker: "Falha ao criar figurinha... tente novamente, talvez agora funcione.",
    link: "Link inválido... ou você digitou errado, ou tentou me testar.",
    erro: "Erro inesperado... relaxa, até máquinas têm dias ruins."
  },
  msg: {
    grupo: "Esse comando só funciona em grupo... aqui no privado não tem plateia.",
    premium: "Acesso premium... parece que você ainda não desbloqueou esse privilégio.",
    mod: "Somente meu criador pode usar isso... e não, não é você.",
    banido: "Você foi banido... às vezes o silêncio também é necessário.",
    donosmt: "Somente meu dono pode usar isso... autoridade limitada detectada.",
    donosmt2: "Comando restrito... você ainda não chegou nesse nível.",
    adm: "Apenas administradores... poder insuficiente detectado.",
    Badmin: "Preciso ser admin... sem isso não faço milagres.",
    privado: "Esse comando só funciona no privado... menos gente, menos vergonha.",
    modobn: "Comandos de brincadeiras só podem ser executados com o modo de brincadeiras ativo."
  }
}
...
const msgCmd = (prefix, groupName, command) => ({
  ativado: `✨ sɪsᴛᴇᴍᴀ *${command}* ᴀᴛɪᴠᴀᴅᴏ!
⌛ ɢʀᴜᴘᴏ: *${groupName}*
💡 sʜɪᴢᴜᴋᴜ ᴅᴇɪxᴏᴜ ᴏ ᴄᴏɴᴛʀᴏʟᴇ ɴᴀs sᴜᴀs ᴍᴀ̃ᴏs... ɴᴀ̃ᴏ ᴇsᴛʀᴀɢᴜᴇ ᴛᴜᴅᴏ.

> ᴘᴀʀᴀ ᴅᴇsᴀᴛɪᴠᴀʀ: *${prefix + command} 0*`.trim(),

  desativado: `‼️ sɪsᴛᴇᴍᴀ *${command}* ᴅᴇsᴀᴛɪᴠᴀᴅᴏ.
⌛ ɢʀᴜᴘᴏ: *${groupName}*
😴 ꜰɪɴᴀʟᴍᴇɴᴛᴇ ᴜᴍ ᴘᴏᴜᴄᴏ ᴅᴇ ᴘᴀᴢ ᴘᴏʀ ᴀǫᴜɪ. sʜɪᴢᴜᴋᴜ ᴅᴇsʟɪɢᴀɴᴅᴏ...

> ᴘᴀʀᴀ ʀᴇᴀᴛɪᴠᴀʀ: *${prefix + command} 1*`.trim()
});


module.exports = { mensagens, enviar, sortear, msgCmd }