...
// Removendo extensões conhecidas (com base em lista manual, já que FileType.extensions foi removido)
const extensoesComuns = ['jpg', 'jpeg', 'png', 'gif', 'webp', 'mp4', 'mp3', 'wav', 'ogg', 'm4a', 'webm', 'pdf', 'zip', 'rar', 'sticker', 'webp']
file = file.split('.').filter(i => !extensoesComuns.includes(i.toLowerCase())).join('.')
